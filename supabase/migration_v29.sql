-- Migration v29: Efero oppretter kundekontoer selv (ingen selv-registrering).
-- superadmin_create_company() lager firma (aktivt, onboarding ferdig) + admin-bruker
-- med passord og BEKREFTET e-post (kan logge inn umiddelbart). Kunden fyller inn
-- timepris/teknikere/logo selv i Innstillinger/Team. Kun superadmin (is_superadmin).
...
BEGIN
  ...
  -- 1. Firma — aktivt og onboarding ferdig (kunden lander rett i appen).
  INSERT INTO companies (
    ...
    now() + interval '30 days', 'active', true,
